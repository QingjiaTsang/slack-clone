...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[100dvh] sm:min-h-[200dvh] flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform scale-[0.55] sm:scale-100"
    >
      <motion.h2
        style={{
